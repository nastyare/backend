...
### 8. **Уроки** (нужно авторизоваться)
1) Создание урока

`POST /lessons` 

2) Получение всех уроков

`GET /lessons` 

3) Получение конкретного урока
...
### 9. **Комментарии** (нужно авторизоваться)

1) Добавить комментарий к уроку

`POST /comments/:lessonId`

2) Получить комментарии к уроку
